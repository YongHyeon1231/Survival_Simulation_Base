...
- **개발 기간:** 2026.04 ~
- **게임 장르:** 서바이벌 / 시뮬레이션
- **프로젝트 브로셔:** [브로셔 보기](https://www.notion.so/Wild-Land-3529cda0656080abb6f4c820371150a6)
...
- **학습 및 참고:** 시스템은 인프런 강의(Pinous의 “[Unity6] 나만의 서바이벌 게임 만들기”)를 기반으로 학습 목적으로 구현하였으며, 이를 바탕으로 프로젝트에 맞게 구조를 수정하고 기능을 확장했습니다.
